                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete_category.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you PAKKA you want to delete this?')" class="label label-important "> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                          <?php } ?>
                        </tbody>
